...
<?php if((isset($deconnection) && $deconnection!=true) || !isset($successSignIn) || !isset($successSignIn) || isset($errorSignIn) || isset($errorLogin)) { ?>
...
<?php
} else if(isset($deconnection) && $deconnection == true) { ?>
