...
<!-- Adresse de la DMI / Contact Ludovic Lepetit et Pierre Veron -->
		<main class="main-content">
			...
			<section class="ludo-contact">
				...
				<div class="ludo-contact-adress">
					<img src="<?= $this->assetUrl('logos/logomailsmall.png');?>" alt=""> Ludovic.lepetit@agglodieppe-maritime.com
				 	<br>
					<img src="<?= $this->assetUrl('logos/logofbsmall.png');?>" alt=""> <a href="#">Ludovic Lepetit - Pro</a></span>
					</div>
			</section>
			<br>
			<section class="pierre-contact">
					...
					<div class="pierre-contact-adress">
						<img src="<?= $this->assetUrl('logos/logomailsmall.png');?>" alt=""> PV@FakeAdress.com
						<br>
						<img src="<?= $this->assetUrl('logos/logofbsmall.png');?>" alt=""> 	<a href="#">Pierre Veron - Pro</a></span>
						</div>
					</section>
 ...
 <!-- Plan Google -->
		...
		<div class="partenaires partenaires-contact">
