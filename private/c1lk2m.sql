...
--
-- Client :  localhost
-- Généré le :  Mar 31 Janvier 2017 à 15:46
...
(97, 'Bonjour, je suis Melinda K.', '2017-01-31 12:21:52', 1, 3),
(98, 'Je souhaite vous soumettre un projet d''impression 3D. Pourriez vous me faire un devis ?', '2017-01-31 12:22:20', 1, 3),
(99, 'Bonjour. Aucun problème, faites-moi parvenir vos documents au format .zip.', '2017-01-31 12:25:02', 3, 1),
(100, 'Très bien. Je vous les transmet sur mon espace personnel.', '2017-01-31 12:25:43', 1, 3);
...
(24, 'Projet d impression', '2017-01-31 14:48:32', 'Bonjour, je souhaiterais imprimer une piece en 3D.\r\nPouvez-vous me faire un devis ?\r\nJ''en aurais besoin demain.');
...
CREATE TABLE IF NOT EXISTS `projects_has_users` (
`id` int(11) NOT NULL,
  `projects_id` int(11) NOT NULL,
  `users_id` int(11) NOT NULL,
...
(1, 'kh', 'mely', 'mely@mail.fr', '$2y$10$smiwHfZw53Q.Rn7PnvAWKOCY3c3eH7qGqyrXcoegyRfYkuuos9c3y', '', '', '2017-01-31 14:09:33', '2017-01-31 12:25:02', 1, 3),
(3, 'Veron', 'Pierre', 'pv@dmi.fr', '$2y$10$SwtO0Fmg0BXy.LiZA7kfAOP828eum.kfXkM2iuKSuQoTXGnc8wlDK', '', '', '2017-01-31 15:39:13', NULL, 1, 2);
...
--
ALTER TABLE `files`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_files_project1_idx` (`projects_id`);

--
-- Index pour la table `messages`
--
ALTER TABLE `messages`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_messages_users1_idx` (`users_id`);

--
-- Index pour la table `news`
--
ALTER TABLE `news`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_news_users1_idx` (`users_id`);

--
-- Index pour la table `news_pictures`
--
ALTER TABLE `news_pictures`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_pictures_news1_idx` (`news_id`);
...
ALTER TABLE `projects_has_users`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `id` (`id`), ADD KEY `fk_project_has_user_user1_idx` (`users_id`), ADD KEY `fk_project_has_user_project1_idx` (`projects_id`), ADD KEY `id_2` (`id`), ADD KEY `id_3` (`id`);
...
--
ALTER TABLE `users`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `mail_UNIQUE` (`mail`), ADD KEY `fk_user_roles_idx` (`roles_id`);
